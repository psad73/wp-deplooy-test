...
class Export_Wp_Page_To_Static_Html_Admin {
    ...
    public function register_export_wp_pages_menu(){
        ...
        add_menu_page(
            ...
            ' data:image/png;base64,',
            89
        );
        ...
        if (!empty($datas)) {
            ...
            if (!$custom_url) {
                foreach ($datas as $key => $page) {
                    ...
                    if($this->getSettings('singlePage') && get_option('rcExportHtmlCreateIndexOnSinglePage', false)){
                        $html_filename = 'index.html';
                    }
...
//        $result = $wpdb->get_var("SELECT COUNT(*) FROM {$wpdb->prefix}export_page_to_html_logs WHERE type = 'cancel_export_process' ");
    ...
    {
        if(strpos($url, 'wp-admin') !== false || strpos($url, 'action=lostpassword') !== false || strpos($url, 'wp-login.php') !== false){
            return true;
        }
        return $exclude_bool;
    }
